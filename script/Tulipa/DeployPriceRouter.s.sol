 ...
 */
contract DeployPriceRouterScript is Script, MainnetAddresses, TulipaContractDeploymentNames {
    using Math for uint256;
    using stdJson for string;

    uint256 public privateKey;
    Deployer public deployer = Deployer(vm.envAddress("DEPLOYER_ADDRESS"));
    ...
    function run() external {
        ...
        priceRouter = PriceRouter(deployer.deployContract(PRICE_ROUTER_NAME, creationCode, constructorArgs, 0));
